    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (path){
            ...
            case "/createReceipt": 
                ...
                break;
            case "/showAddBrand":
                request.getRequestDispatcher("/WEB-INF/showAddBrand.jsp").forward(request, response);
                break;
            case "/createBrand":
                String brand = request.getParameter("brand");
                if ("".equals(brand)) {
                    request.setAttribute("info", "Напишите бренд!");
                    request.getRequestDispatcher("/showAddBrand").forward(request, response);
                }
                Brand newBrand = new Brand();
                newBrand.setBrand(brand);
                brandFacade.create(newBrand);
                request.setAttribute("info", "Вы добавили брэнд!");
                request.getRequestDispatcher("/showAddBrand").forward(request, response);
                break;
            case "/showAddSneaker":
                ...
                break;
            case "/createSneaker":
                Brand brandId = brandFacade.find(Long.parseLong(request.getParameter("brandsId")));
                ...
                sneaker.setSneakerFirm(brandId);
