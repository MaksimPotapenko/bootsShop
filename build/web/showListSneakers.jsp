    ...
    <div class="col-4">
        <div class="card" style="margin-bottom: 25px">
           ...
           <center><div class="card-body">
            <small><p class="card-title" >${entry.key.sneakerFirm.brand} ${entry.key.sneakerModel}</p></small>
            ...
            <a href="buySneaker?sneakerId=${entry.key.id}" role="button" class="btn btn-secondary btn-sm">Купить</a>
            </div></center>
        </div>
    </div>
    </c:forEach>
